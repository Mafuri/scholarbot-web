...
All SQLAlchemy models live here so each router can import cleanly.
"""
import uuid
import os
...
class User(Base):
    ...
    # GPA stored on 4.0 scale internally; original stored for display
    ...
    def to_dict(self, include_password: bool = False) -> dict:
        d = {
            ...
            "gpa": self.gpa,
            "gpa_original": self.gpa_original,
...
class Application(Base):
    ...
    def to_dict(self) -> dict:
        return {
            ...
            "url": self.url,
            "status": self.stage or "researching",
            "notes": self.notes,
...
class Package(Base):
    ...
    def to_dict(self) -> dict:
        preview = (
            (self.essay_text or "")[:150] + "..."
            if self.essay_text else ""
        )
        return {
            "id": self.id,
            "user_id": self.user_id,
            ...
            "essay_version": self.essay_version,
